...
public class BlackShellExplosion : MonoBehaviour
{
    ...
    public float m_MaxLifeTime = 10.0f;                    // The time in seconds before the shell is removed.
    ...
    private void Start()
    {
        ...
        moveZ = this.transform.position.z;
